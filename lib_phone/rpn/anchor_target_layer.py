...
from generate_anchors import generate_anchors_phone
...
class AnchorTargetLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        self._anchors = generate_anchors_phone()
    ...
    def forward(self, bottom, top):
        ...
        for batch_image in range(batch_size):
            ...
            bbox_outside_weights_all.append(bbox_outside_weights)
            
        labels_all = np.vstack(labels_all)
        bbox_targets_all = np.vstack(bbox_targets_all)
        bbox_inside_weights_all = np.vstack(bbox_inside_weights_all)
        bbox_outside_weights_all = np.vstack(bbox_outside_weights_all)
