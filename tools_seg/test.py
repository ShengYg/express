...
def main(model_name, resize):
    ...
    log_dir = os.path.join(os.getcwd(), 'tools_seg', 'logs', 'frontend_TIME-20171105-222746')
    model_file = os.path.join(log_dir, 'phone_450000.h5')
    ...
    test_loader = torch.utils.data.DataLoader(
        PhoneSeg(root, split='test', transform=True, resize=resize),
