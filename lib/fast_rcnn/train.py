...
class SolverWrapper(object):
    ...
    def __init__(self, solver_prototxt, roidb, pid_and_index, output_dir, pretrained_model=None):
        ...
        self.solver.net.layers[0].set_roidb(roidb, pid_and_index)
...
def train_net(solver_prototxt, roidb, pid_and_index, output_dir,
              pretrained_model=None, max_iters=40000):
    """Train a Fast R-CNN network."""

    roidb = filter_roidb(roidb)
    sw = SolverWrapper(solver_prototxt, roidb, pid_and_index, output_dir,
